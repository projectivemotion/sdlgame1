...
${OBJECTDIR}/src/BackgroundScene.o: src/BackgroundScene.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude/ `pkg-config --cflags SDL2_ttf` `pkg-config --cflags SDL2_image` `pkg-config --cflags sdl2` `pkg-config --cflags SDL2_mixer`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BackgroundScene.o src/BackgroundScene.cpp
