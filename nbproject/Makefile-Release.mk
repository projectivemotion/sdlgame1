...
${OBJECTDIR}/src/MinesDrawable.o: src/MinesDrawable.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude/ `pkg-config --cflags SDL2_ttf` `pkg-config --cflags SDL2_image` `pkg-config --cflags sdl2` `pkg-config --cflags SDL2_mixer`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MinesDrawable.o src/MinesDrawable.cpp

${OBJECTDIR}/src/MinesState.o: src/MinesState.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude/ `pkg-config --cflags SDL2_ttf` `pkg-config --cflags SDL2_image` `pkg-config --cflags sdl2` `pkg-config --cflags SDL2_mixer`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MinesState.o src/MinesState.cpp
...
${OBJECTDIR}/src/assetslib.o: src/assetslib.cc
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude/ `pkg-config --cflags SDL2_ttf` `pkg-config --cflags SDL2_image` `pkg-config --cflags sdl2` `pkg-config --cflags SDL2_mixer`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/assetslib.o src/assetslib.cc
...
${OBJECTDIR}/src/render/EntityRenderer.o: src/render/EntityRenderer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude/ `pkg-config --cflags SDL2_ttf` `pkg-config --cflags SDL2_image` `pkg-config --cflags sdl2` `pkg-config --cflags SDL2_mixer`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/render/EntityRenderer.o src/render/EntityRenderer.cpp
...
${OBJECTDIR}/src/scene/MinesScene.o: src/scene/MinesScene.cpp
	${MKDIR} -p ${OBJECTDIR}/src/scene
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude/ `pkg-config --cflags SDL2_ttf` `pkg-config --cflags SDL2_image` `pkg-config --cflags sdl2` `pkg-config --cflags SDL2_mixer`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/scene/MinesScene.o src/scene/MinesScene.cpp

${OBJECTDIR}/src/scene/SpriteScene.o: src/scene/SpriteScene.cpp
	${MKDIR} -p ${OBJECTDIR}/src/scene
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude/ `pkg-config --cflags SDL2_ttf` `pkg-config --cflags SDL2_image` `pkg-config --cflags sdl2` `pkg-config --cflags SDL2_mixer`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/scene/SpriteScene.o src/scene/SpriteScene.cpp
